...
export const SAMPLE_POS_DATA = [
  ...
  { date: '2026-08-02', storeId: 'STR-102', storeName: 'Bengaluru Tech Park Outlet', productId: 'PRD-003', productName: 'Ergonomic Mesh Office Chair', category: 'Furniture', quantity: 6, revenue: 71994, unitCost: 7200, latitude: 12.9716, longitude: 77.5946 },
  { date: '2026-08-05', storeId: 'STR-102', storeName: 'Bengaluru Tech Park Outlet', productId: 'PRD-010', productName: 'Motorized Standing Desk', category: 'Furniture', quantity: 5, revenue: 149995, unitCost: 16800, latitude: 12.9716, longitude: 77.5946 },
...
export const SAMPLE_INVENTORY_DATA = [
  ...
  { productId: 'PRD-005', productName: 'Organic South Indian Coffee 1kg', category: 'Grocery', currentStock: 12, reorderLevel: 30, unitCost: 240.00, supplier: 'Tata Coffee Co', lastRestocked: '2026-07-01' },
  { productId: 'PRD-006', productName: 'Stainless Steel Thermos Bottle', category: 'Accessories', currentStock: 85, reorderLevel: 25, unitCost: 160.00, supplier: 'Milton Hydro', lastRestocked: '2026-07-15' },
  ...
  { productId: 'PRD-011', productName: 'Premium Wool Winter Coat', category: 'Apparel', currentStock: 35, reorderLevel: 10, unitCost: 2800.00, supplier: 'Monte Carlo Wear', lastRestocked: '2026-07-08' },
